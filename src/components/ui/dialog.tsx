...
// Re-skinned per README §6.1 to match the Modal component in
// templates.jsx: 4px backdrop blur, text-tinted (not pure black) overlay
// at ~60% transparency via color-mix, radius --radius-lg.
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      'fixed inset-0 z-50 bg-[color-mix(in_oklch,var(--c-text),transparent_60%)] backdrop-blur-[4px] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn('tt-head text-lg leading-none tracking-[-0.03em]', className)}
    {...props}
  />
));
