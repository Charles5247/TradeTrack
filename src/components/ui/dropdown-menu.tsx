...
>(({ className, inset, children, ...props }, ref) => (
  ...
  >
    {children}
    <ChevronRight className="ml-auto" strokeWidth={1.75} />
  </DropdownMenuPrimitive.SubTrigger>
));
DropdownMenuSubTrigger.displayName = DropdownMenuPrimitive.SubTrigger.displayName;

// Re-skinned per README §6.1 — aligned with the Modal/popover styling
// (rounded-lg, border-border, bg-popover which aliases --c-surface).
