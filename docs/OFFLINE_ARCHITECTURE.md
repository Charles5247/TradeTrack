# TracKasuwa — Offline Architecture

## Overview

TracKasuwa is designed as an **offline-first PWA**. The system operates fully without an internet connection and synchronizes changes when connectivity is restored.
...
```
Database: TracKasuwaDB (version 2)
...
TracKasuwa uses a **last-write-wins** strategy with server authority:
...
1. Open TracKasuwa in Chrome DevTools
