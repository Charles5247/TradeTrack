/**
 * TracKasuwa Desktop — preload script.
 *
 ...
 * loaded web app (TracKasuwa running in the BrowserWindow) never gets
 * direct Node/Electron API access. Only the few things a POS desktop
 * shell legitimately needs are exposed, via `window.TracKasuwaDesktop`.
 */

const { contextBridge, ipcRenderer } = require("electron");

contextBridge.exposeInMainWorld("TracKasuwaDesktop", {
