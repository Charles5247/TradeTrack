-- ============================================================
-- Migration 005: Fix role model — replace invalid 'owner' role
-- with 'super_admin' in RLS policies (users.role CHECK only
-- allows super_admin, admin, cashier per migration 001).
-- ============================================================
